...
#
# Generated by export_simulation on Fri Aug 01 22:59:58 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './rom_28x2500.sh' script.

./rom_28x2500.sh -reset_run
...
./rom_28x2500.sh -noclean_files

For more information on the script, please type './rom_28x2500.sh -help'.
